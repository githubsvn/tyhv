 ...
 * NewsLanguage
 *
 * @ORM\Table(name="mtx_page_language")
 * @ORM\Entity(repositoryClass="SM\Bundle\AdminBundle\Repository\PageLanguageRepository")
...
class PageLanguage {
     ...
     * Set page
     *
     * @param \SM\Bundle\AdminBundle\Entity\Page $page
     * @return PageLanguage
     */
