...
/* SMAdminBundle:Test:edit.html.twig */
class __TwigTemplate_79ef3b431166da8383e1d5f47bc81c5f extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_test_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "SMAdminBundle:Test:edit.html.twig";
    }
