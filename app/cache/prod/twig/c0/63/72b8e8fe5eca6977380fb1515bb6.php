...
class __TwigTemplate_c06372b8e8fe5eca6977380fb1515bb6 extends Twig_Template
{
...
<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_role_update", array("id" => $this->getAttribute($_entity_, "id"))), "html", null, true);
        echo "\" method=\"post\" ";
