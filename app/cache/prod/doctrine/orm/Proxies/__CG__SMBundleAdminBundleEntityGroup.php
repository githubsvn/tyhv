 ...
 */
class Group extends \SM\Bundle\AdminBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'created_at', 'updated_at', 'active', 'role_collection');
    }
