 ...
 */
class BranchLanguage extends \SM\Bundle\AdminBundle\Entity\BranchLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'language', 'branch');
    }
