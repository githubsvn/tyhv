 ...
 */
class CompanyTypeLanguage extends \SM\Bundle\AdminBundle\Entity\CompanyTypeLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'companytype', 'language');
    }
