 ...
 */
class Category extends \SM\Bundle\AdminBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addCategoryLanguage($categoryLanguages);
    }

    public function removeCategoryLanguage(\SM\Bundle\AdminBundle\Entity\CategoryLanguage $categoryLanguages)
    {
        $this->__load();
        return parent::removeCategoryLanguage($categoryLanguages);
    }

    public function getCategoryLanguages()
    {
        $this->__load();
        return parent::getCategoryLanguages();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'lft', 'rgt', 'status', 'created_at', 'updated_at', 'parent', 'children', 'created', 'updated', 'category_languages');
    }
