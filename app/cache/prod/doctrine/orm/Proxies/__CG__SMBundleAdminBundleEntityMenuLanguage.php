 ...
 */
class MenuLanguage extends \SM\Bundle\AdminBundle\Entity\MenuLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'alias', 'menu', 'language');
    }
