 ...
 */
class ProductLanguage extends \SM\Bundle\AdminBundle\Entity\ProductLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'product', 'language');
    }
