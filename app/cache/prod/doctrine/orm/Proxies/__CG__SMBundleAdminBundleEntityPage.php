 ...
 */
class Page extends \SM\Bundle\AdminBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addPageLanguage($pageLanguages);
    }

    public function removePageLanguage(\SM\Bundle\AdminBundle\Entity\PageLanguage $pageLanguages)
    {
        $this->__load();
        return parent::removePageLanguage($pageLanguages);
    }

    public function getPageLanguages()
    {
        $this->__load();
        return parent::getPageLanguages();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'status', 'created_at', 'updated_at', 'image', 'created', 'updated', 'page_languages', 'media_id');
    }
