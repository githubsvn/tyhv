 ...
 */
class ProductGroupLanguage extends \SM\Bundle\AdminBundle\Entity\ProductGroupLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'language', 'productgroup');
    }
