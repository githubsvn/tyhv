 ...
 */
class MediaCategoryLanguage extends \SM\Bundle\AdminBundle\Entity\MediaCategoryLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setMediacategory($mediacategory);
    }

    public function getMediacategory()
    {
        $this->__load();
        return parent::getMediacategory();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'mediacategory', 'language');
    }
