 ...
 */
class CategoryLanguage extends \SM\Bundle\AdminBundle\Entity\CategoryLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'category', 'language');
    }
